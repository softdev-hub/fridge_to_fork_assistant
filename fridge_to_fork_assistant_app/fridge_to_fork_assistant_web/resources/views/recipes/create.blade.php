...
@section('page-title', 'Thêm công thức mới')
@section('page-subtitle', 'Tạo công thức nấu ăn mới')
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-input" rows="3"
                            placeholder="Mô tả ngắn về món ăn...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div class="form-group">
                            ...
                            <input type="number" name="cooking_time_minutes" id="cooking_time_minutes" class="form-input"
                                value="{{ old('cooking_time_minutes') }}" min="1">
                        </div>
                        <div class="form-group">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div class="form-group">
                            ...
                            <select name="meal_type" id="meal_type" class="form-select">
                                ...
                                <option value="breakfast" {{ old('meal_type') == 'breakfast' ? 'selected' : '' }}>Bữa sáng
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="difficulty" id="difficulty" class="form-select">
                                ...
                                <option value="medium" {{ old('difficulty') == 'medium' ? 'selected' : '' }}>Trung bình
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="cuisine" id="cuisine" class="form-input" value="{{ old('cuisine') }}"
                ...
                <div>
                    <div class="form-group">
                        ...
                        <textarea name="instructions" id="instructions" class="form-input" rows="10"
                            placeholder="Các bước thực hiện...">{{ old('instructions') }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="video_url" id="video_url" class="form-input" value="{{ old('video_url') }}"
                            placeholder="https://...">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="source_url" id="source_url" class="form-input"
                            value="{{ old('source_url') }}" placeholder="https://...">
                    </div>
                </div>
            </div>
